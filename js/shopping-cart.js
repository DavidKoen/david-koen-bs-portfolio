...
function display_all() {
    ...
    myTable += "<th style='width: 100px; color: red; text-align: right;'>Add 1 Item</th>";
    myTable += "<th style='width: 100px; color: red; text-align: right;'>Remove 1 Item</th>";
    ...
    for (i = 0; i < items.length; i++) {
        ...
        myTable += "<td><button onclick='add_selection(" + i + ")'>Add 1 Item</button></td>";
        myTable += "<td><button onclick='remove_selection(" + i + ")'>Remove 1 Item</button></td>";
    }
